...
{
    public class SettingsTabRecord_PrimarchAssault : SettingsTabRecord
    {
        ...
        public SettingsTabRecord_PrimarchAssault(SettingsTabDef def, string label, Action clickedAction, Func<bool> selected)
        ...
        public override void OnGUI(Rect rect)
        {
            ...
            {
                if (GameComponent_ChallengeManager.Instance != null && GameComponent_ChallengeManager.Instance.HealthBar != null)
                {
            ...
            {
                foreach (var assaultEventActionProperties in assaultEventDef.actionProperties.Where(p => !uniqueEventActionNames.Contains(p.actionName)))
                {
